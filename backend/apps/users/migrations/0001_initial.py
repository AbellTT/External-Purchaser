    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('PROCUREMENT_OFFICER', 'Procurement Officer'), ('DELIVERY_STAFF', 'Delivery Staff')], default='PROCUREMENT_OFFICER', max_length=30)),
