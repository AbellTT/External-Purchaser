    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_name', models.CharField(blank=True, default='piece', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('savings_vs_merkato', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12)),
                ('savings_vs_regular', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12)),
